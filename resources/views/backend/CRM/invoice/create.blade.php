    ...
    <div class="row">
        <div class="col-lg-6">
            <x-backend.form.form action="{{ \App\Utilities\Url::admin('crm/invoice/create') }}" method="post">
                @csrf
                <x-backend.card title="ایجاد  فاکتور جدید">
                    <div class="row ">
                        ...
                        <div class="col-lg-6 mt-8 mb-3">
                            <x-backend.form.form-group title="نوع :" isInline="true">
                                <x-backend.form.radio-inline>
                                    ...
                                    value="{{\App\Models\CRM\PreInvoice::TYPE_RASMI}}" checked="true"/>
                                    <x-backend.form.radio title="غیر رسمی" name="type" value="{{\App\Models\CRM\PreInvoice::TYPE_GHEYRE_RASMI}}"/>
                                </x-backend.form.radio-inline>
                            </x-backend.form.form-group>
                        </div>
{{--                        <div class="col-lg-6">--}}
