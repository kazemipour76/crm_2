...
{{--                            <h3 class="card-title fw-bolder text-white">فروش امار</h3>--}}
...
{{--                                    <!--begin::Svg Icon | path: icons/duotone/قالب بندی/قالب بندی-4-blocks-2.svg-->--}}
...
{{--                                                        <!--end::Input-->--}}
{{--                                                        <!--end::برچسب-->--}}
{{--                                                        <span class="form-check-label text-muted fs-6">منابع</span>--}}
{{--                                                        <!--end::برچسب-->--}}
{{--                                                    </label>--}}
{{--                                                    <!--end::Switch-->--}}
{{--                                                </div>--}}
...
{{--															</span>--}}
{{--                                        <!--end::Svg Icon-->--}}
{{--                                        <a href="#" class="text-warning fw-bold fs-6">فروش هفتگی</a>--}}
{{--                                    </div>--}}
{{--                                    <!--end::Col-->--}}
{{--                                    <!--begin::Col-->--}}
{{--                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">--}}
{{--                                        <!--begin::Svg Icon | path: icons/duotone/ارتباط/Add-user.svg-->--}}
...
{{--															</span>--}}
{{--                                        <!--end::Svg Icon-->--}}
{{--                                        <a href="#" class="text-primary fw-bold fs-6">جدید کاربران</a>--}}
{{--                                    </div>--}}
{{--                                    <!--end::Col-->--}}
{{--                                </div>--}}
{{--                                <!--end::Row-->--}}
...
{{--															</span>--}}
{{--                                        <!--end::Svg Icon-->--}}
{{--                                        <a href="#" class="text-danger fw-bold fs-6 mt-2">مورد سفارشات</a>--}}
{{--                                    </div>--}}
{{--                                    <!--end::Col-->--}}
{{--                                    <!--begin::Col-->--}}
{{--                                    <div class="col bg-light-success px-6 py-8 rounded-2">--}}
{{--                                        <!--begin::Svg Icon | path: icons/duotone/ارتباط/فوری-mail.svg-->--}}
...
{{--															</span>--}}
{{--                                        <!--end::Svg Icon-->--}}
{{--                                        <a href="#" class="text-success fw-bold fs-6 mt-2">گزارش اشکالات</a>--}}
{{--                                    </div>--}}
{{--                                    <!--end::Col-->--}}
{{--                                </div>--}}
{{--                                <!--end::Row-->--}}
...
{{--                                            <!--begin::Input-->--}}
{{--                                            <div>--}}
{{--                                                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="انتخاب گزینه" data-allow-clear="true">--}}
{{--                                                    <option></option>--}}
...
{{--                                            <button type="reset" class="btn btn-sm btn-white btn-active-light-primary me-2" data-kt-menu-dismiss="true">ریست</button>--}}
...
{{--                                    <div class="me-2">--}}
{{--                                        <a href="#" class="text-dark text-hover-primary fw-bolder fs-3">گزارش ایجاد کنید</a>--}}
{{--                                        <div class="text-muted fs-7 fw-bold">سرمایه گذاری</div>--}}
{{--                                    </div>--}}
{{--                                    <div class="fw-bolder fs-3 text-primary"> 24,500 تومان  </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <!--end::Stats-->--}}
{{--                            <!--begin::Chart-->--}}
...
{{--                                <div class="me-2">--}}
{{--                                    <span class="fw-bolder text-gray-800 d-block fs-3">فروش</span>--}}
{{--                                    <span class="text-gray-400 fw-bold">8 آذر - 20 آذر</span>--}}
{{--                                </div>--}}
{{--                                <div class="fw-bolder fs-3 text-primary"> 15,300 تومان  </div>--}}
{{--                            </div>--}}
{{--                            <!--end::Hidden-->--}}
{{--                            <!--begin::Chart-->--}}
...
{{--                            <h3 class="card-title align-items-start flex-column">--}}
{{--                                <span class="card-label fw-bolder fs-3 mb-1">اعضا امار</span>--}}
{{--                                <span class="text-muted mt-1 fw-bold fs-7">بالای 500 عضو</span>--}}
{{--                            </h3>--}}
{{--                            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="برای افزودن کاربر کلیک کنید">--}}
...
{{--                                            </div>--}}
{{--                                        </th>--}}
{{--                                        <th class="min-w-150px">نویسندگان</th>--}}
{{--                                        <th class="min-w-140px">کمپانی</th>--}}
{{--                                        <th class="min-w-120px">پردازش</th>--}}
...
{{--                                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">محمد رضایی</a>--}}
{{--                                                    <span class="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </td>--}}
{{--                                        <td>--}}
{{--                                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">ساتراس</a>--}}
{{--                                            <span class="text-muted fw-bold text-muted d-block fs-7">طراحی وب</span>--}}
{{--                                        </td>--}}
{{--                                        <td class="text-end">--}}
...
{{--                                                <!--begin::Svg Icon | path: icons/duotone/عمومی/تنظیمات-1.svg-->--}}
{{--                                                <span class="svg-icon svg-icon-3">--}}
{{--																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">--}}
{{--																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--																					<rect x="0" y="0" width="24" height="24" />--}}
...
{{--                                            </a>--}}
{{--                                            <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">--}}
{{--                                                <!--begin::Svg Icon | path: icons/duotone/ارتباط/نوشتن.svg-->--}}
{{--                                                <span class="svg-icon svg-icon-3">--}}
{{--																			<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">--}}
...
{{--                                                <!--begin::Svg Icon | path: icons/duotone/عمومی/Trash.svg-->--}}
{{--                                                <span class="svg-icon svg-icon-3">--}}
{{--																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">--}}
{{--																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--																					<rect x="0" y="0" width="24" height="24" />--}}
...
{{--                                                </div>--}}
{{--                                                <div class="d-flex justify-content-start flex-column">--}}
{{--                                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">علی رضایی</a>--}}
{{--                                                    <span class="text-muted fw-bold text-muted d-block fs-7">C#, ASP.NET, MS SQL</span>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </td>--}}
{{--                                        <td>--}}
{{--                                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">غلامی</a>--}}
{{--                                            <span class="text-muted fw-bold text-muted d-block fs-7">منازل و هتل ها</span>--}}
{{--                                        </td>--}}
{{--                                        <td class="text-end">--}}
{{--                                            <div class="d-flex flex-column w-100 me-2">--}}
{{--                                                <div class="d-flex flex-stack mb-2">--}}
...
{{--                                                </div>--}}
{{--                                                <div class="d-flex justify-content-start flex-column">--}}
{{--                                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">محمد ابراهیمی</a>--}}
{{--                                                    <span class="text-muted fw-bold text-muted d-block fs-7">PHP, Laravel, VueJS</span>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </td>--}}
{{--                                        <td>--}}
{{--                                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">جوادی</a>--}}
{{--                                            <span class="text-muted fw-bold text-muted d-block fs-7">حمل و نقل</span>--}}
{{--                                        </td>--}}
{{--                                        <td class="text-end">--}}
{{--                                            <div class="d-flex flex-column w-100 me-2">--}}
{{--                                                <div class="d-flex flex-stack mb-2">--}}
...
{{--                                                </div>--}}
{{--                                                <div class="d-flex justify-content-start flex-column">--}}
{{--                                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">محسن برومند</a>--}}
{{--                                                    <span class="text-muted fw-bold text-muted d-block fs-7">Python, PostgreSQL, ReactJS</span>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </td>--}}
{{--                                        <td>--}}
{{--                                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">کاوorنی</a>--}}
{{--                                            <span class="text-muted fw-bold text-muted d-block fs-7">بیمه</span>--}}
{{--                                        </td>--}}
{{--                                        <td class="text-end">--}}
{{--                                            <div class="d-flex flex-column w-100 me-2">--}}
{{--                                                <div class="d-flex flex-stack mb-2">--}}
...
{{--                                                </div>--}}
{{--                                                <div class="d-flex justify-content-start flex-column">--}}
{{--                                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">اتنا رضایی</a>--}}
{{--                                                    <span class="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </td>--}}
{{--                                        <td>--}}
{{--                                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">جوادی</a>--}}
{{--                                            <span class="text-muted fw-bold text-muted d-block fs-7">کارگردان هنری</span>--}}
{{--                                        </td>--}}
{{--                                        <td class="text-end">--}}
{{--                                            <div class="d-flex flex-column w-100 me-2">--}}
{{--                                                <div class="d-flex flex-stack mb-2">--}}
...
{{--                        <!--begin::Header-->--}}
{{--                        <div class="card-header border-0">--}}
{{--                            <h3 class="card-title fw-bolder text-dark">نویسندگان</h3>--}}
{{--                            <div class="card-toolbar">--}}
{{--                                <!--begin::Menu-->--}}
{{--                                <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">--}}
{{--                                    <!--begin::Svg Icon | path: icons/duotone/قالب بندی/قالب بندی-4-blocks-2.svg-->--}}
...
{{--                                    <!--end::Menu item-->--}}
{{--                                    <!--begin::Menu item-->--}}
{{--                                    <div class="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-kt-menu-flip="left-start, top">--}}
{{--                                        <!--begin::Menu item-->--}}
{{--                                        <a href="#" class="menu-link px-3">--}}
...
{{--                                <!--begin::Text-->--}}
{{--                                <div class="flex-grow-1">--}}
{{--                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">مرادی نیا</a>--}}
...
{{--                                <!--begin::Text-->--}}
{{--                                <div class="flex-grow-1">--}}
{{--                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">رضا علی ابادی</a>--}}
{{--                                    <span class="text-muted d-block fw-bold">PHP, SQLite, Artisan CLI</span>--}}
{{--                                </div>--}}
{{--                                <!--end::Text-->--}}
{{--                            </div>--}}
...
{{--                                <!--begin::Text-->--}}
{{--                                <div class="flex-grow-1">--}}
{{--                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">محمد رصایی</a>--}}
{{--                                    <span class="text-muted d-block fw-bold">PHP, SQLite, Artisan CLI</span>--}}
{{--                                </div>--}}
{{--                                <!--end::Text-->--}}
{{--                            </div>--}}
...
{{--                                <!--begin::Text-->--}}
{{--                                <div class="flex-grow-1">--}}
{{--                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">علی کاربر</a>--}}
{{--                                    <span class="text-muted d-block fw-bold">PHP, SQLite, Artisan CLI</span>--}}
{{--                                </div>--}}
{{--                                <!--end::Text-->--}}
{{--                            </div>--}}
...
{{--                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">جشن ناهار گروهی</a>--}}
{{--                                    <span class="text-muted fw-bold d-block">سررسید در 2 روز</span>--}}
{{--                                </div>--}}
{{--                                <!--end::Title-->--}}
{{--                                <!--begin::Lable-->--}}
...
{{--                                <!--begin::Title-->--}}
{{--                                <div class="flex-grow-1 me-2">--}}
{{--                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">بهینه سازی پیمایش</a>--}}
{{--                                    <span class="text-muted fw-bold d-block">سررسید در 2 روز</span>--}}
{{--                                </div>--}}
{{--                                <!--end::Title-->--}}
{{--                                <!--begin::Lable-->--}}
...
{{--                                <!--begin::Title-->--}}
{{--                                <div class="flex-grow-1 me-2">--}}
{{--                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">پلان و استراتژی</a>--}}
{{--                                    <span class="text-muted fw-bold d-block">سررسید در 5 روز</span>--}}
{{--                                </div>--}}
{{--                                <!--end::Title-->--}}
{{--                                <!--begin::Lable-->--}}
...
{{--                                <!--begin::Title-->--}}
{{--                                <div class="flex-grow-1 me-2">--}}
{{--                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">استراتژی اهداف محصول</a>--}}
{{--                                    <span class="text-muted fw-bold d-block">سررسید در 7 روز پیش</span>--}}
{{--                                </div>--}}
{{--                                <!--end::Title-->--}}
{{--                                <!--begin::Lable-->--}}
...
{{--                                    </div>--}}
{{--                                    <span class="badge badge-light fw-bolder my-2">+82 تومان </span>--}}
{{--                                </div>--}}
{{--                                <!--end::بخش-->--}}
{{--                            </div>--}}
{{--                            <!--end::item-->--}}
...
{{--                                    </div>--}}
{{--                                    <span class="badge badge-light fw-bolder my-2">+280 تومان </span>--}}
{{--                                </div>--}}
{{--                                <!--end::بخش-->--}}
{{--                            </div>--}}
{{--                            <!--end::item-->--}}
...
{{--                                    </div>--}}
{{--                                    <span class="badge badge-light fw-bolder my-2">+4500 تومان </span>--}}
{{--                                </div>--}}
{{--                                <!--end::بخش-->--}}
{{--                            </div>--}}
{{--                            <!--end::item-->--}}
...
{{--                                    <!--end::بخش-->--}}
{{--                                    <!--begin::برچسب-->--}}
{{--                                    <div class="badge badge-light fw-bold py-4 px-3">+82 تومان </div>--}}
{{--                                    <!--end::برچسب-->--}}
{{--                                </div>--}}
{{--                                <!--end::item-->--}}
{{--                                <!--begin::item-->--}}
...
{{--                                <ul class="nav">--}}
{{--                                    <li class="nav-item">--}}
{{--                                        <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary active fw-bolder px-4 me-1" data-bs-toggle="tab" href="#kt_table_widget_5_tab_1">ماه</a>--}}
{{--                                    </li>--}}
{{--                                    <li class="nav-item">--}}
{{--                                        <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary fw-bolder px-4 me-1" data-bs-toggle="tab" href="#kt_table_widget_5_tab_2">هفته</a>--}}
{{--                                    </li>--}}
{{--                                    <li class="nav-item">--}}
{{--                                        <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary fw-bolder px-4" data-bs-toggle="tab" href="#kt_table_widget_5_tab_3">روز</a>--}}
{{--                                    </li>--}}
{{--                                </ul>--}}
{{--                            </div>--}}
{{--                        </div>--}}
