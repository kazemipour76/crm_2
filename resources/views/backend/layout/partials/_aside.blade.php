...
{{--            <img alt="Logo" src="{{ asset('assets/media/logos/logo-light.png') }}"/>--}}
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item @if(request()->is('sadmin/dash')) menu-item-active @endif" aria-haspopup="true">
                    <a href="{{ \App\Utilities\Url::admin('dash') }}" class="menu-link">
                        <i class="menu-icon fal fa-tachometer-alt-fastest"></i>
                        <span class="menu-text">داشبورد</span>
                    </a>
                </li>
                <li class="menu-item @if(request()->is('sadmin/crm/customer')) menu-item-active @endif"
                    aria-haspopup="true">
                    <a href="{{ \App\Utilities\Url::admin('crm/customer') }}" class="menu-link">
                ...
                <li class="menu-item @if(request()->is('sadmin/crm/preInvoice')) menu-item-active @endif"
                    ...
                    <a href="{{ \App\Utilities\Url::admin('crm/preInvoice') }}" class="menu-link">
                        <i class="menu-icon fal fa-file-invoice" aria-hidden="true"></i>
                        <span class="menu-text">پیش فاکتورها </span>
                    </a>
                </li>
                <li class="menu-item @if(request()->is('sadmin/crm/invoice')) menu-item-active @endif"
                    aria-haspopup="true">
                    <a href="{{ \App\Utilities\Url::admin('crm/invoice') }}" class="menu-link">
                        <i class="menu-icon fal fa-file-invoice-dollar" aria-hidden="true"></i>
                        <span class="menu-text">فاکتور ها </span>
                    </a>
                </li>
